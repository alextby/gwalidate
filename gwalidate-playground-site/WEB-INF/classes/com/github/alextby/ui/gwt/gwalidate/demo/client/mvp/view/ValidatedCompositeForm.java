 ...
 */
public class ValidatedCompositeForm extends Composite implements HasValidatorDelegate {

	interface ValidatedSubFormBinder extends UiBinder<HTMLPanel, ValidatedCompositeForm> {
	}
	...
	@UiField(provided = true)
	ValidatedSimpleForm validatedSimpleForm;
	...
	@Inject
	public ValidatedCompositeForm(ValidationPanel panel, ValidatedSimpleForm simpleForm) {
		this.validationPanel = panel;
		this.validatedSimpleForm = simpleForm;
